  ...
  return (
    ...
    <div className="App">
      <header className="App-header">
        ...
        {/* <ProjectCard title="RutgersChatbot:" description="A conversational A.I. built for Rutgers Course Planning." link="https://github.com/MugPand/RutgersChatbot" technologies="Python, React, JavaScript, sklearn, NumPy, SQL, Pandas"/>
        <ProjectCard title="eq:" description="A simple social media template website originally built to be a distraction-free social forum where users could chat about emotions, get advice, and connect with others." image={eqLogo} link="https://github.com/MugPand/RutgersChatbot" technologies="Built using Next.js, React, TypeScript, Tailwind, Firebase Authentication and Firebase Firestore."/>
        ...
        <h6 className="Footer">Designed & Developed by Mugdhesh Pandkar &copy; 2024</h6>
